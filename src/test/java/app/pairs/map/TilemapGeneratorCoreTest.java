...
class TilemapGeneratorCoreTest {
    ...
    void rejectsZeroTypes() {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> new CustomizedTilemapFactory()
                        .setWidth(4).setHeight(4).setTypes(0).generate())
    ...
    void rejectsNegativeTypes() {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> new CustomizedTilemapFactory()
                        .setWidth(4).setHeight(4).setTypes(-3).generate())
                .withMessageContaining("types must be >= 1");
    }
    ...
    void rejectsOddFillableTileCount() {
        ...
        assertThatIllegalArgumentException()
                .isThrownBy(() -> new CustomizedTilemapFactory()
                        .setWidth(3).setHeight(3).setTypes(1).generate())
    ...
    void rejectsInsufficientTilesForTypes() {
        ...
        assertThatIllegalArgumentException()
                .isThrownBy(() -> new CustomizedTilemapFactory()
                        .setWidth(2).setHeight(2).setTypes(3).generate())
